...
function AddProduct() {
  ...
  const [selectedOption, setSelectedOption] = useState("skirt"); // Установлено значение по умолчанию для выбранного варианта
  const [hideType, setHideType] = useState(true); // Установлено значение по умолчанию для выпадающего списка
